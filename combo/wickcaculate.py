'''
In this module, it includes some operation to deal a wick case.
'''
import sympy as sy
from sympy import false, symbols 
from sympy.utilities.iterables import multiset_partitions #用于集合划分的包
from itertools import permutations#用于排列
...
class Wick:
    ...
    def generalizedWick(self):
        ...
        with tqdm(total=len(part), desc="generalize wick caculating") as pbar:
